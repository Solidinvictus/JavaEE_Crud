                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="page-header"  style="text-align: center; margin-top: 5px">
                                    <h3 style="color:blue; text-decoration: underline ">Insert Users</h3>
                                    <h5 style="color:red;">Notice</h5>
                                    <h6 style="color:red;">Don't worry about this message if occures when inserting:</h6>
                                    <h6 style="color:red;">Problems for inserting: Duplicate entry </h6>
                                    <h6 style="color:red;">The operation will be executed succesfuly</h6>
                                </div>
                                <form action="User" method="POST"  class="form-horizontal">
                                   ...
                                   <div class="form-group form-group-sm">
                                    ...
                                    <div class="form-group form-group-sm">
                                       ...
                                       <div class="col-md-8">	
                                            <input type="radio" name="baned" value="1">Yes <input type="radio" name="baned" value="0">No
                                       </div>
                                    </div>
